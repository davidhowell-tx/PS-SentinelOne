This document is an attempt to map SentinelOne API options to the PS-SentinelOne module based on how they're organized in the SentinelOne API Documentation
